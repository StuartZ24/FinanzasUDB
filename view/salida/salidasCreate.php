            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Crear Salidas</h1>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form class="g-3 needs-validation" novalidate>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="tipoSalida" placeholder="Tipo de Salida" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" class="form-control" id="montoSalida" placeholder="Monto" required>
                                                <div class="invalid-feedback">
                                                    Monto es requerido
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="fechaSalida" placeholder="Fecha de Salida" required>
                                            <div class="invalid-feedback">
